  ...
  return (
    <div className="upwork-badge-wrapper">
      <div className="upwork-card">
        ...
        <h3 className="upwork-title">TOP RATED PLUS</h3>
        <div className="upwork-divider" />
        <span className="upwork-verified">Verified on</span>
        <div className="upwork-logo-lockup">
          <svg
            className="upwork-mark"
            viewBox="0 0 24 24"
          ...
          <span className="upwork-wordmark">Upwork</span>
        </div>
        <a
          target="_blank"
          rel="noopener noreferrer"
          className="upwork-hire-btn"
